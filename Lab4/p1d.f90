...
! Programa p1d
!
! Este programa calcula los cumulantes de Binder de un sistema de ns por ns
! spines con condiciones de contorno periodicas, en funcion de la temperatura.
...
! Abrimos el documento de dexto y describimos los datos a anotar
  open(440,file='40.d')
  write(440,1) 'Temperatura', 'Cumulante de Binder'
...
!     Calculamos el valor de m a la 2 y a la 4
      m2 = m2 + mu(s)**2  ! <m^2>
      m4 = m4 + mu(s)**4  ! <m^4>
    end do
!   Normalizamos los valores obtenidos
    m2 = m2/real(nsim,pr)!/(V*V)        ! Magnetizacion cuadrada
    m4 = m4/real(nsim,pr)!/(V*V*V*V)    ! Magnetizacion cuarta
    U  = 1._pr - m4/(3._pr*m2*m2)      ! Cumulante de Binder
